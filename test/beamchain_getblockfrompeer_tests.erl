...
%% ensure_loaded: passthrough recompiles the original and needs it loaded
%% (clean-clone eunit otherwise crashes meck_proc:start).
install_mocks(HeaderKnown, HasBlock, PeersFun) ->
    ...
    {module, beamchain_peer_manager} = code:ensure_loaded(beamchain_peer_manager),
